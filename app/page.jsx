            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-7xl">
              {categories
                .filter((category) => {
                  ...
                  if (filter === "Vegetarian") return category.strCategory.toLowerCase().includes("vegetarian");
                  if (filter === "Non-Vegetarian") return !category.strCategory.toLowerCase().includes("vegetarian");
                  return true;
                })
                .map((category) => (
